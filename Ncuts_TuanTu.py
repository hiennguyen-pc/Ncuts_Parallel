...
if __name__ == '__main__':
    image = skimage.img_as_ubyte(skimage.io.imread('C:/Users/Admin/HienNguyen/VietBao/Normalized-Cut/ncut/test.jpg',as_gray=False))#smaller than 100*100px better
